...
python3 code/eval_tttlm.py --task pile_github  --num_neighbors 20 --embedding_model_checkpoint models/roberta-large-pile-lr2e-5-bs16-8gpu/checkpoint-1700000 --learning_rate 5e-6 --address_path servers/addresses.txt --results_dir results_neo/ > job_output_neogithub.log 2>&1 
